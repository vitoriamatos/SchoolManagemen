...
<div class="container app">
			<div class="row">
				<div class="col-md-3 menu">
					<ul class="list-group">
						<li class="list-group-item "><a href="registro_disciplina.php">Cadastro</a></li>
						<li class="list-group-item active"><a href="lista_disciplinas.php">Todos as Disciplinas</a></li>
					</ul>
				</div>
							...
							<div class="col">
								...
								<hr />
									<?php foreach($disciplines as $index => $discipline): ?>
										...
										<div class="col-sm-9" id="task_<?= $discipline->id ?>"><?= $discipline->name ?> </div>
