...
require ROOT_PATH . '\controller\ClassesController.php';
...
<div class="container app">
			<div class="row">
				<div class="col-md-3 menu">
					<ul class="list-group">
						<li class="list-group-item "><a href="registro_turma.php">Cadastro</a></li>
						<li class="list-group-item active"><a href="lista_turmas.php">Todas as turmas</a></li>
					</ul>
				</div>
					...
					<div class="container pagina">
						<div class="row">
							<div class="col">
								...
								<hr />
									<?php foreach($classes as $index => $classess): ?>
										<div class="row mb-3 d-flex align-items-center tarefa">
										<div class="col-sm-9" id="task_<?= $classess->id ?>"><?= $classess->name ?> </div>
