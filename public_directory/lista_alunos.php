...
require ROOT_PATH . '\controller\StudentController.php';
...
<div class="container app">
			<div class="row">
				<div class="col-md-3 menu">
					<ul class="list-group">
						<li class="list-group-item "><a href="registro_aluno.php">Cadastro</a></li>
						<li class="list-group-item active"><a href="lista_alunos.php">Todos os Alunos</a></li>
					</ul>
				</div>
				...
				<div class="col-sm-9">
					<div class="container pagina">
						<div class="row">
							<div class="col">
								<h4>Alunos Matrículados</h4>
								<hr />
									<?php foreach($students as $index => $student): ?>
										<div class="row mb-3 d-flex align-items-center tarefa">
										<div class="col-sm-9" id="task_<?= $student->id ?>"><?= $student->name ?> </div>
										<div class="col-sm-3 mt-2 d-flex justify-content-between">
											...
											<i class="fas fa-check-square fa-lg text-success" onclick="checkDone(<?= $task->id ?>)"></i>
											-->
											</div>
										</div>
								   <?php endforeach ?>
